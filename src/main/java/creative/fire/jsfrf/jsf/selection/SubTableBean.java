...
public class SubTableBean {
	...
	public SubTableBean() {
		...
		this.regions.add(new Region("华东地区", ps));
		...
		this.regions.add(new Region("中南地区", ps));
		...
		this.regions.add(new Region("西南地区", ps));
